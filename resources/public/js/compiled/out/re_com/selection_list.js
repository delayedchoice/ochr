...
re_com.selection_list.list_container = (function re_com$selection_list$list_container(p__35209){
...
var args = map__35210__$1;
var disabled_QMARK_ = cljs.core.get.call(null,map__35210__$1,new cljs.core.Keyword(null,"disabled?","disabled?",-1523234181));
var on_change = cljs.core.get.call(null,map__35210__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
var height = cljs.core.get.call(null,map__35210__$1,new cljs.core.Keyword(null,"height","height",1025178622));
var item_renderer = cljs.core.get.call(null,map__35210__$1,new cljs.core.Keyword(null,"item-renderer","item-renderer",-743065410));
var model = cljs.core.get.call(null,map__35210__$1,new cljs.core.Keyword(null,"model","model",331153215));
var attr = cljs.core.get.call(null,map__35210__$1,new cljs.core.Keyword(null,"attr","attr",-604132353));
var label_fn = cljs.core.get.call(null,map__35210__$1,new cljs.core.Keyword(null,"label-fn","label-fn",-860923263));
var required_QMARK_ = cljs.core.get.call(null,map__35210__$1,new cljs.core.Keyword(null,"required?","required?",-872514462));
var as_exclusions_QMARK_ = cljs.core.get.call(null,map__35210__$1,new cljs.core.Keyword(null,"as-exclusions?","as-exclusions?",-55596285));
var max_height = cljs.core.get.call(null,map__35210__$1,new cljs.core.Keyword(null,"max-height","max-height",-612563804));
var hide_border_QMARK_ = cljs.core.get.call(null,map__35210__$1,new cljs.core.Keyword(null,"hide-border?","hide-border?",1792698922));
var width = cljs.core.get.call(null,map__35210__$1,new cljs.core.Keyword(null,"width","width",-384071477));
var choices = cljs.core.get.call(null,map__35210__$1,new cljs.core.Keyword(null,"choices","choices",1385611597));
var id_fn = cljs.core.get.call(null,map__35210__$1,new cljs.core.Keyword(null,"id-fn","id-fn",316222798));
var style = cljs.core.get.call(null,map__35210__$1,new cljs.core.Keyword(null,"style","style",-496642736));
var class$ = cljs.core.get.call(null,map__35210__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
var multi_select_QMARK_ = cljs.core.get.call(null,map__35210__$1,new cljs.core.Keyword(null,"multi-select?","multi-select?",973156151));
...
var items = cljs.core.map.call(null,(cljs.core.truth_(item_renderer)?((function (selected,map__35210,map__35210__$1,args,disabled_QMARK_,on_change,height,item_renderer,model,attr,label_fn,required_QMARK_,as_exclusions_QMARK_,max_height,hide_border_QMARK_,width,choices,id_fn,style,class$,multi_select_QMARK_){
return (function (p1__35206_SHARP_){
return item_renderer.call(null,p1__35206_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__35210,map__35210__$1,args,disabled_QMARK_,on_change,height,item_renderer,model,attr,label_fn,required_QMARK_,as_exclusions_QMARK_,max_height,hide_border_QMARK_,width,choices,id_fn,style,class$,multi_select_QMARK_))
:(cljs.core.truth_(multi_select_QMARK_)?((function (selected,map__35210,map__35210__$1,args,disabled_QMARK_,on_change,height,item_renderer,model,attr,label_fn,required_QMARK_,as_exclusions_QMARK_,max_height,hide_border_QMARK_,width,choices,id_fn,style,class$,multi_select_QMARK_){
return (function (p1__35207_SHARP_){
return re_com.selection_list.as_checked.call(null,p1__35207_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__35210,map__35210__$1,args,disabled_QMARK_,on_change,height,item_renderer,model,attr,label_fn,required_QMARK_,as_exclusions_QMARK_,max_height,hide_border_QMARK_,width,choices,id_fn,style,class$,multi_select_QMARK_))
:((function (selected,map__35210,map__35210__$1,args,disabled_QMARK_,on_change,height,item_renderer,model,attr,label_fn,required_QMARK_,as_exclusions_QMARK_,max_height,hide_border_QMARK_,width,choices,id_fn,style,class$,multi_select_QMARK_){
return (function (p1__35208_SHARP_){
return re_com.selection_list.as_radio.call(null,p1__35208_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__35210,map__35210__$1,args,disabled_QMARK_,on_change,height,item_renderer,model,attr,label_fn,required_QMARK_,as_exclusions_QMARK_,max_height,hide_border_QMARK_,width,choices,id_fn,style,class$,multi_select_QMARK_))
)),choices);
...
re_com.selection_list.selection_list.cljs$core$IFn$_invoke$arity$variadic = (function (p__35213){
...
var args = map__35214__$1;
if((((!(goog.DEBUG)))?true:re_com.validate.validate_args.call(null,re_com.validate.extract_arg_data.call(null,re_com.selection_list.selection_list_args_desc),args,"selection-list"))){
} else {
throw (new Error("Assert failed: (validate-args-macro selection-list-args-desc args \"selection-list\")"));
}

return ((function (map__35214,map__35214__$1,args){
return (function() { 
var G__35222__delegate = function (p__35216){
...
while (G__35223__i < G__35223__a.length) {G__35223__a[G__35223__i] = arguments[G__35223__i + 0]; ++G__35223__i;}
  p__35216 = new cljs.core.IndexedSeq(G__35223__a,0,null);
} 
return G__35222__delegate.call(this,p__35216);};
G__35222.cljs$lang$maxFixedArity = 0;
G__35222.cljs$lang$applyTo = (function (arglist__35224){
var p__35216 = cljs.core.seq(arglist__35224);
return G__35222__delegate(p__35216);
});
G__35222.cljs$core$IFn$_invoke$arity$variadic = G__35222__delegate;
return G__35222;
})()
;
;})(map__35214,map__35214__$1,args))
});

re_com.selection_list.selection_list.cljs$lang$maxFixedArity = (0);

/** @this {Function} */
re_com.selection_list.selection_list.cljs$lang$applyTo = (function (seq35212){
var self__4718__auto__ = this;
return self__4718__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq35212));
});


//# sourceMappingURL=selection_list.js.map?rel=1561299747160
