...
return (new CustomEvent(event_name,(function (){var obj42749 = ({"detail":data});
return obj42749;
})()));
} else {
...
var f = (function (){var pred__42756 = cljs.core._EQ_;
var expr__42757 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__42756.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__42757))){
return ((function (pred__42756,expr__42757){
return (function (p1__42750_SHARP_){
return console.warn(p1__42750_SHARP_);
});
;})(pred__42756,expr__42757))
} else {
if(cljs.core.truth_(pred__42756.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__42757))){
return ((function (pred__42756,expr__42757){
return (function (p1__42751_SHARP_){
return console.debug(p1__42751_SHARP_);
});
;})(pred__42756,expr__42757))
} else {
if(cljs.core.truth_(pred__42756.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__42757))){
return ((function (pred__42756,expr__42757){
return (function (p1__42752_SHARP_){
return console.error(p1__42752_SHARP_);
});
;})(pred__42756,expr__42757))
} else {
return ((function (pred__42756,expr__42757){
return (function (p1__42753_SHARP_){
return console.log(p1__42753_SHARP_);
});
;})(pred__42756,expr__42757))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__42760){
...
var opts = map__42761__$1;
var eval_fn = cljs.core.get.call(null,map__42761__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__42763_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__42765,(0),null);
var v = cljs.core.nth.call(null,vec__42765,(1),null);
...
}catch (e42770){if((e42770 instanceof Error)){
var e = e42770;
return not_found;
} else {
throw e42770;
...
//# sourceMappingURL=utils.js.map?rel=1561299757099
