...
var G__25488 = o;
(G__25488[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
var G__25492 = o;
(G__25492[reagent.impl.template.cached_custom_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
if(cljs.core.ifn_QMARK_.call(null,x)){
return (function() { 
var G__25493__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
...
while (G__25494__i < G__25494__a.length) {G__25494__a[G__25494__i] = arguments[G__25494__i + 0]; ++G__25494__i;}
  args = new cljs.core.IndexedSeq(G__25494__a,0,null);
} 
...
var args = cljs.core.seq(arglist__25495);
...
var G__25497 = props;
var G__25497__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__25497,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__25497);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__25497__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__25498){
...
var props = map__25499__$1;
var class$ = cljs.core.get.call(null,map__25499__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
if(cljs.core.coll_QMARK_.call(null,class$)){
return cljs.core.assoc.call(null,props,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",cljs.core.keep.call(null,((function (map__25499,map__25499__$1,props,class$){
return (function (c){
...
});})(map__25499,map__25499__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__25501){
var map__25502 = p__25501;
var map__25502__$1 = (((((!((map__25502 == null))))?(((((map__25502.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__25502.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__25502):map__25502);
var on_write = cljs.core.get.call(null,map__25502__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render.call(null,((function (node_value,map__25502,map__25502__$1,on_write){
return (function (){
return reagent.impl.template.input_component_set_value.call(null,component);
});})(node_value,map__25502,map__25502__$1,on_write))
);
} else {
...
var G__25505 = jsprops;
(G__25505["defaultValue"] = value);

(G__25505["onChange"] = ((function (G__25505,v,value,on_change){
return (function (p1__25504_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__25504_SHARP_);
});})(G__25505,v,value,on_change))
);
...
var vec__25508 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__25508,(0),null);
var id = cljs.core.nth.call(null,vec__25508,(1),null);
var class$ = cljs.core.nth.call(null,vec__25508,(2),null);
...
var jsprops = ({"argv": v});
var temp__5739__auto___25512 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5739__auto___25512 == null)){
} else {
var key_25513 = temp__5739__auto___25512;
(jsprops["key"] = key_25513);
}
...
var temp__5739__auto___25514 = reagent.impl.template.key_from_vec.call(null,argv);
if((temp__5739__auto___25514 == null)){
} else {
var key_25515 = temp__5739__auto___25514;
reagent.impl.template.oset.call(null,jsprops,"key",key_25515);
}
...
var G__25516 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__25516["name"] = c);
...
var len__4730__auto___25522 = arguments.length;
var i__4731__auto___25523 = (0);
while(true){
if((i__4731__auto___25523 < len__4730__auto___25522)){
args__4736__auto__.push((arguments[i__4731__auto___25523]));

var G__25524 = (i__4731__auto___25523 + (1));
i__4731__auto___25523 = G__25524;
continue;
} else {
}
break;
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq25520){
...
break;
default:
var G__25527 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
v = G__25527;
continue;
...
var n__4607__auto___25529 = a.length;
var i_25530 = (0);
while(true){
if((i_25530 < n__4607__auto___25529)){
(a[i_25530] = reagent.impl.template.as_element.call(null,(a[i_25530])));
...
var a = cljs.core.into_array.call(null,s);
var n__4607__auto___25532 = a.length;
var i_25533 = (0);
while(true){
if((i_25533 < n__4607__auto___25532)){
var val_25534 = (a[i_25533]);
if(((cljs.core.vector_QMARK_.call(null,val_25534)) && ((reagent.impl.template.key_from_vec.call(null,val_25534) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_25533] = reagent.impl.template.as_element.call(null,val_25534));

var G__25535 = (i_25533 + (1));
i_25533 = G__25535;
continue;
} else {
}
...
var ctx = ({});
var vec__25536 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__25536,(0),null);
var derefed = cljs.core.nth.call(null,vec__25536,(1),null);
...
var G__25539 = (cljs.core.count.call(null,argv) - first_child);
switch (G__25539) {
case (0):
...
break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv.call(null,((function (G__25539){
...
//# sourceMappingURL=template.js.map?rel=1561299739004
