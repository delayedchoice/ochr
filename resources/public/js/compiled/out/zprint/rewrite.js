...
var G__37863 = rewrite_clj.zip.next.call(null,n);
loc = G__37863;
continue;
} else {
var G__37864 = rewrite_clj.zip.next.call(null,loc);
loc = G__37864;
continue;
}
} else {
var G__37865 = rewrite_clj.zip.next.call(null,loc);
loc = G__37865;
continue;
}
}
...
return rewrite_clj.zip.replace.call(null,zloc,rewrite_clj.zip.root.call(null,zprint.rewrite.prewalk_subtree.call(null,p_QMARK_,f,(function (){var G__37866 = zloc;
var G__37866__$1 = (((G__37866 == null))?null:rewrite_clj.zip.node.call(null,G__37866));
if((G__37866__$1 == null)){
return null;
} else {
return zprint.zutil.edn_STAR_.call(null,G__37866__$1);
}
})())));
});
/**
...
var G__37867 = rewrite_clj.zip.down.call(null,nloc);
nloc = G__37867;
continue;
}
break;
...
var G__37868 = rewrite_clj.zip.right.call(null,nloc);
var G__37869 = cljs.core.conj.call(null,out,nloc);
nloc = G__37868;
out = G__37869;
continue;
} else {
...
var G__37870 = rewrite_clj.zip.right.call(null,replaced_loc);
var G__37871 = cljs.core.next.call(null,new_loc);
var G__37872 = replaced_loc;
nloc = G__37870;
new_loc = G__37871;
last_loc = G__37872;
continue;
...
var new_dep = zprint.rewrite.prewalk.call(null,zloc,(function (p1__37873_SHARP_){
return ((cljs.core._EQ_.call(null,rewrite_clj.zip.tag.call(null,p1__37873_SHARP_),new cljs.core.Keyword(null,"token","token",-1211463215))) && (cljs.core._EQ_.call(null,rewrite_clj.zip.sexpr.call(null,p1__37873_SHARP_),new cljs.core.Keyword(null,"dependencies","dependencies",1108064605))));
}),zprint.rewrite.sort_down);
return new_dep;
});

//# sourceMappingURL=rewrite.js.map?rel=1561299750800
