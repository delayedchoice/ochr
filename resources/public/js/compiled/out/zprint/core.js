...
var vec__38740 = (cljs.core.truth_(new cljs.core.Keyword(null,"zipper?","zipper?",-1061271842).cljs$core$IFn$_invoke$arity$1(options))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [coll,options], null):(cljs.core.truth_(new cljs.core.Keyword(null,"parse-string?","parse-string?",2006674325).cljs$core$IFn$_invoke$arity$1(options))?((typeof coll === 'string')?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [zprint.core.get_zipper.call(null,options,coll),options], null):(function(){throw (new Error(["Collection is not a string yet"," :parse-string? specified!"].join('')))})()):(cljs.core.truth_(new cljs.core.Keyword(null,"zloc?","zloc?",-1457193855).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"focus","focus",234677911).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"output","output",-1105869043).cljs$core$IFn$_invoke$arity$1(options))))?(function (){var vec__38743 = zprint.zutil.find_root_and_path_nw.call(null,coll);
var root = cljs.core.nth.call(null,vec__38743,(0),null);
var path = cljs.core.nth.call(null,vec__38743,(1),null);
...
var input = cljs.core.nth.call(null,vec__38740,(0),null);
var options__$1 = cljs.core.nth.call(null,vec__38740,(1),null);
 ...
 */
zprint.core.process_rest_options = (function zprint$core$process_rest_options(internal_options,p__38746){
var vec__38747 = p__38746;
var width_or_options = cljs.core.nth.call(null,vec__38747,(0),null);
var options = cljs.core.nth.call(null,vec__38747,(1),null);
...
var vec__38753 = zprint.config.perform_remove.call(null,null,null,zprint.config.get_options.call(null),rest_options);
var internal_map = cljs.core.nth.call(null,vec__38753,(0),null);
var rest_options__$1 = cljs.core.nth.call(null,vec__38753,(1),null);
var _ = cljs.core.nth.call(null,vec__38753,(2),null);
var vec__38756 = zprint.config.apply_style.call(null,null,null,internal_map,rest_options__$1);
var updated_map = cljs.core.nth.call(null,vec__38756,(0),null);
var ___$1 = cljs.core.nth.call(null,vec__38756,(1),null);
var style_errors = cljs.core.nth.call(null,vec__38756,(2),null);
 ...
 */
zprint.core.range_vec = (function zprint$core$range_vec(v,p__38761){
var vec__38762 = p__38761;
var start = cljs.core.nth.call(null,vec__38762,(0),null);
var end = cljs.core.nth.call(null,vec__38762,(1),null);
...
var vec__38768 = zprint.core.process_rest_options.call(null,internal_options,rest);
var special_option = cljs.core.nth.call(null,vec__38768,(0),null);
var rest_options = cljs.core.nth.call(null,vec__38768,(1),null);
...
var vec__38771 = zprint.core.zprint_STAR_.call(null,coll,special_option,actual_options);
var cvec = cljs.core.nth.call(null,vec__38771,(0),null);
var options = cljs.core.nth.call(null,vec__38771,(1),null);
...
/** @this {Function} */
zprint.core.czprint_str_internal.cljs$lang$applyTo = (function (seq38765){
...
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__38766,G__38767,seq38765__$2);
});
...
/** @this {Function} */
zprint.core.zprint_str.cljs$lang$applyTo = (function (seq38779){
var G__38780 = cljs.core.first.call(null,seq38779);
var seq38779__$1 = cljs.core.next.call(null,seq38779);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__38780,seq38779__$1);
});
...
/** @this {Function} */
zprint.core.czprint_str.cljs$lang$applyTo = (function (seq38784){
var G__38785 = cljs.core.first.call(null,seq38784);
var seq38784__$1 = cljs.core.next.call(null,seq38784);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__38785,seq38784__$1);
});
...
/** @this {Function} */
zprint.core.zprint.cljs$lang$applyTo = (function (seq38789){
var G__38790 = cljs.core.first.call(null,seq38789);
var seq38789__$1 = cljs.core.next.call(null,seq38789);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__38790,seq38789__$1);
});
...
var args__4736__auto__ = [];
var len__4730__auto___38796 = arguments.length;
var i__4731__auto___38797 = (0);
while(true){
if((i__4731__auto___38797 < len__4730__auto___38796)){
args__4736__auto__.push((arguments[i__4731__auto___38797]));

var G__38798 = (i__4731__auto___38797 + (1));
i__4731__auto___38797 = G__38798;
continue;
} else {
}
break;
...
/** @this {Function} */
zprint.core.czprint.cljs$lang$applyTo = (function (seq38794){
 ...
 */
zprint.core.process_form = (function zprint$core$process_form(rest_options,zprint_fn,zprint_specifier,p__38800,form){
var vec__38801 = p__38800;
var next_options = cljs.core.nth.call(null,vec__38801,(0),null);
var _ = cljs.core.nth.call(null,vec__38801,(1),null);
var indent = cljs.core.nth.call(null,vec__38801,(2),null);
var zprint_num = cljs.core.nth.call(null,vec__38801,(3),null);
...
var vec__38804 = (cljs.core.truth_((function (){var and__4120__auto__ = comment_QMARK_;
if(cljs.core.truth_(and__4120__auto__)){
...
var new_options = cljs.core.nth.call(null,vec__38804,(0),null);
var error_str = cljs.core.nth.call(null,vec__38804,(1),null);
...
//# sourceMappingURL=core.js.map?rel=1561299752165
