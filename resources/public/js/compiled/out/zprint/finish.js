...
zprint.finish.no_style_map = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"f","f",-1597136552),(function (p1__38017_SHARP_){
if(cljs.core.not_EQ_.call(null,p1__38017_SHARP_,new cljs.core.Keyword(null,"none","none",1333468478))){
return cljs.core.conj.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"reverse","reverse",-888455266)], null),p1__38017_SHARP_);
} else {
 ...
 */
zprint.finish.within_QMARK_ = (function zprint$finish$within_QMARK_(n,p__38018){
var vec__38019 = p__38018;
var low = cljs.core.nth.call(null,vec__38019,(0),null);
var high = cljs.core.nth.call(null,vec__38019,(1),null);
return (((n >= low)) && ((n <= high)));
});
/**
 ...
 */
zprint.finish.ground_color_to_style = (function zprint$finish$ground_color_to_style(p__38022,s,color,element,idx){
...
var style_map = cljs.core.get.call(null,map__38023__$1,new cljs.core.Keyword(null,"style-map","style-map",1488693527));
var focus = cljs.core.get.call(null,map__38023__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var select = cljs.core.get.call(null,map__38023__$1,new cljs.core.Keyword(null,"select","select",1147833503));
 ...
 */
zprint.finish.add_length = (function zprint$finish$add_length(p__38025){
var vec__38026 = p__38025;
var s = cljs.core.nth.call(null,vec__38026,(0),null);
var style = cljs.core.nth.call(null,vec__38026,(1),null);
var start = cljs.core.nth.call(null,vec__38026,(2),null);
 ...
 *   which are in focus.
 */
zprint.finish.gc_vec_to_style_vec = (function zprint$finish$gc_vec_to_style_vec(ctx,idx,p__38029){
var vec__38030 = p__38029;
var s = cljs.core.nth.call(null,vec__38030,(0),null);
var keyword_color = cljs.core.nth.call(null,vec__38030,(1),null);
var element = cljs.core.nth.call(null,vec__38030,(2),null);
...
var G__38033 = cljs.core.next.call(null,ssv);
var G__38034 = (this_ssv == null);
var G__38035 = (cljs.core.truth_(this_elide)?this_elide:last_elide);
var G__38036 = ((((doing_nil_QMARK_) && ((this_ssv == null))))?out:((((doing_nil_QMARK_) && ((!((this_ssv == null))))))?cljs.core.conj.call(null,cljs.core.conj.call(null,cljs.core.conj.call(null,out,zprint.finish.gc_vec_to_style_vec.call(null,ctx,(0),this_elide)),zprint.finish.gc_vec_to_style_vec.call(null,ctx,(0),elide__$1)),this_ssv):(((this_ssv == null))?out:cljs.core.conj.call(null,out,this_ssv)
)));
ssv = G__38033;
doing_nil_QMARK_ = G__38034;
last_elide = G__38035;
out = G__38036;
continue;
}
...
var vec__38040 = cljs.core.first.call(null,remaining_cvec);
var _ = cljs.core.nth.call(null,vec__38040,(0),null);
var ___$1 = cljs.core.nth.call(null,vec__38040,(1),null);
var element_type = cljs.core.nth.call(null,vec__38040,(2),null);
...
var G__38043 = cljs.core.next.call(null,remaining_cvec);
var G__38044 = new_idx;
var G__38045 = cljs.core.conj.call(null,out,new_idx);
remaining_cvec = G__38043;
idx = G__38044;
out = G__38045;
continue;
}
 ...
 */
zprint.finish.replace_focus_w_cursor = (function zprint$finish$replace_focus_w_cursor(gcw_vec,p__38056,cursor_vec){
var vec__38057 = p__38056;
var focus_start = cljs.core.nth.call(null,vec__38057,(0),null);
var focus_end = cljs.core.nth.call(null,vec__38057,(1),null);
var focus_vec = vec__38057;
...
var vec__38060 = cljs.core.split_at.call(null,focus_start,gcw_vec);
var front = cljs.core.nth.call(null,vec__38060,(0),null);
var back = cljs.core.nth.call(null,vec__38060,(1),null);
 ...
 */
zprint.finish.color_style = (function zprint$finish$color_style(p__38063){
var vec__38064 = p__38063;
var s = cljs.core.nth.call(null,vec__38064,(0),null);
var color = cljs.core.nth.call(null,vec__38064,(1),null);
if((color == null)){
return s;
} else {
...
zprint.finish.cursor_style.cljs$core$IFn$_invoke$arity$2 = (function (p__38070,existing_count){
var vec__38071 = p__38070;
var s = cljs.core.nth.call(null,vec__38071,(0),null);
var cursor = cljs.core.nth.call(null,vec__38071,(1),null);
...
return cljs.core.filterv.call(null,((function (s__$1,len,cursor__$1,vec__38071,s,cursor){
return (function (p1__38067_SHARP_){
return (!(cljs.core.empty_QMARK_.call(null,cljs.core.first.call(null,p1__38067_SHARP_))));
});})(s__$1,len,cursor__$1,vec__38071,s,cursor))
...
var vec__38078 = cljs.core.first.call(null,cvec_nl);
var n = cljs.core.nth.call(null,vec__38078,(0),null);
var where = cljs.core.nth.call(null,vec__38078,(1),null);
var cvec_element = vec__38078;
if((cvec_element == null)){
var G__38081 = cljs.core.next.call(null,cvec_nl);
var G__38082 = (idx + (1));
var G__38083 = start;
var G__38084 = out;
cvec_nl = G__38081;
...
var G__38085 = cljs.core.next.call(null,cvec_nl);
var G__38086 = (idx + (1));
var G__38087 = idx;
var G__38088 = cljs.core.conj.call(null,out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null));
cvec_nl = G__38085;
idx = G__38086;
start = G__38087;
out = G__38088;
...
var G__38089 = cljs.core.next.call(null,cvec_nl);
var G__38090 = (idx + (1));
var G__38091 = (idx + (1));
var G__38092 = cljs.core.conj.call(null,out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null));
cvec_nl = G__38089;
idx = G__38090;
start = G__38091;
out = G__38092;
...
var G__38093 = cljs.core.next.call(null,cvec_nl);
var G__38094 = (idx + (1));
var G__38095 = idx;
var G__38096 = cljs.core.apply.call(null,cljs.core.conj,cljs.core.conj.call(null,out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null)),cljs.core.repeat.call(null,n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [idx,idx], null)));
cvec_nl = G__38093;
idx = G__38094;
start = G__38095;
out = G__38096;
...
var G__38097 = cljs.core.next.call(null,cvec_nl);
var G__38098 = (idx + (1));
var G__38099 = start;
var G__38100 = cljs.core.apply.call(null,cljs.core.conj,out,cljs.core.repeat.call(null,n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null)));
cvec_nl = G__38097;
idx = G__38098;
start = G__38099;
out = G__38100;
...
return cljs.core.reduce.call(null,(function (p1__38102_SHARP_,p2__38101_SHARP_){
if(zprint.finish.within_QMARK_.call(null,idx,p2__38101_SHARP_)){
return cljs.core.reduced.call(null,p1__38102_SHARP_);
} else {
return (p1__38102_SHARP_ + (1));
}
}),(0),lines);
});
/**
 ...
 */
zprint.finish.surround_focus = (function zprint$finish$surround_focus(lines_to_cvec,p__38103,p__38104){
var vec__38105 = p__38103;
var focus_begin = cljs.core.nth.call(null,vec__38105,(0),null);
var focus_end = cljs.core.nth.call(null,vec__38105,(1),null);
var vec__38108 = p__38104;
var before = cljs.core.nth.call(null,vec__38108,(0),null);
var after = cljs.core.nth.call(null,vec__38108,(1),null);
 ...
 */
zprint.finish.handle_lines = (function zprint$finish$handle_lines(p__38112,cvec,focus_vec){
...
var options = map__38113__$1;
var map__38114 = cljs.core.get.call(null,map__38113__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
...
var focus = cljs.core.get.call(null,map__38114__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var lines = cljs.core.get.call(null,map__38114__$1,new cljs.core.Keyword(null,"lines","lines",-700165781));
var paths = cljs.core.get.call(null,map__38114__$1,new cljs.core.Keyword(null,"paths","paths",-1807389588));
...
var path_vecs__$1 = cljs.core.map.call(null,((function (lines_to_cvec,surround,cvec_ranges,cvec_ranges__$1,path_vecs,map__38113,map__38113__$1,options,map__38114,map__38114__$1,focus,lines,paths){
return (function (p1__38111_SHARP_){
return zprint.finish.surround_focus.call(null,lines_to_cvec,p1__38111_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null));
});})(lines_to_cvec,surround,cvec_ranges,cvec_ranges__$1,path_vecs,map__38113,map__38113__$1,options,map__38114,map__38114__$1,focus,lines,paths))
,path_vecs);
...
//# sourceMappingURL=finish.js.map?rel=1561299751105
