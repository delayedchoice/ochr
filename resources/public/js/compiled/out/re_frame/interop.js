...
return [(function (){var pred__25655 = cljs.core.instance_QMARK_;
var expr__25656 = reactive_val;
if(cljs.core.truth_(pred__25655.call(null,reagent.ratom.RAtom,expr__25656))){
return "ra";
} else {
if(cljs.core.truth_(pred__25655.call(null,reagent.ratom.RCursor,expr__25656))){
return "rc";
} else {
if(cljs.core.truth_(pred__25655.call(null,reagent.ratom.Reaction,expr__25656))){
return "rx";
} else {
if(cljs.core.truth_(pred__25655.call(null,reagent.ratom.Track,expr__25656))){
return "tr";
} else {
return "other";
}
...
//# sourceMappingURL=interop.js.map?rel=1561299739155
