...
var o36437 = temp__5733__auto__;
var temp__5733__auto____$1 = (o36437["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o36438 = temp__5733__auto____$1;
return (o36438["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__35547__auto__ = f;
return (o__35547__auto__["toString"]).call(o__35547__auto__);
} else {
return "";
}
}catch (e36439){var _ = e36439;
return "";
}});
...
try{var o__35547__auto___36441 = t;
(o__35547__auto___36441["cljs$lang$ctorPrWriter"]).call(o__35547__auto___36441,t,writer);
}catch (e36440){var __36442 = e36440;
}
...
var char_code = (function (){var o__35547__auto__ = (new String(char$));
return (o__35547__auto__["charCodeAt"]).call(o__35547__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__35547__auto__ = String;
return (o__35547__auto__["fromCharCode"]).call(o__35547__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__36443 = num_code;
switch (G__36443) {
case (1):
return (185);
...
var o__35547__auto__ = String;
return (o__35547__auto__["fromCharCode"]).call(o__35547__auto__,superscript_code);
});
/**
...
}catch (e36445){var _e__35554__auto__ = e36445;
return false;
}})())){
...
var vec__36446 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__36446,(0),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var o36449 = temp__5733__auto__;
var temp__5733__auto____$1 = (o36449["dependencies_"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o36450 = temp__5733__auto____$1;
return (o36450["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__36453){
var vec__36454 = p__36453;
var ns_detector = cljs.core.nth.call(null,vec__36454,(0),null);
...
var G__36460 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__36461 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__36460;
remaining_tokens = G__36461;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq36451){
var G__36452 = cljs.core.first.call(null,seq36451);
var seq36451__$1 = cljs.core.next.call(null,seq36451);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__36452,seq36451__$1);
});
...
var vec__36465 = cljs.core.split_with.call(null,(function (p1__36464_SHARP_){
return cljs.core.not_EQ_.call(null,p1__36464_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__36465,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__36465,(1),null);
...
var vec__36471 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__36471,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__36471,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__36474 = cljs.core.rest.call(null,remaining_tokens);
var G__36475 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__36474;
name_tokens = G__36475;
continue;
} else {
...
var vec__36478 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__36478,(0),null);
var arity = cljs.core.nth.call(null,vec__36478,(1),null);
var vec__36481 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__36481,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__36481,(1),null);
var vec__36484 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__36484,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__36484,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__36484,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__36484,(3),null);
...
var vec__36490 = result;
var munged_ns = cljs.core.nth.call(null,vec__36490,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__36490,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__36490,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__36490,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__36490,(4),null);
var arity = cljs.core.nth.call(null,vec__36490,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__36494 = temp__5733__auto__;
var munged_name = cljs.core.nth.call(null,vec__36494,(0),null);
var args = cljs.core.nth.call(null,vec__36494,(1),null);
var vec__36497 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__36497,(0),null);
var name = cljs.core.nth.call(null,vec__36497,(1),null);
...
var G__36500 = (arity + (1));
var G__36501 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__36502){
var vec__36503 = p__36502;
var arity = cljs.core.nth.call(null,vec__36503,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__36503,(1),null);
...
return cljs.core.get.call(null,arities,p1__36506_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__36507_SHARP_);
...
var G__36516 = (i__4731__auto___36515 + (1));
i__4731__auto___36515 = G__36516;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__36510){
var vec__36511 = p__36510;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__36511,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq36508){
var G__36509 = cljs.core.first.call(null,seq36508);
var seq36508__$1 = cljs.core.next.call(null,seq36508);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__36509,seq36508__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__36519__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__36519__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__36519__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__36519__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__36520 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__36520,(0),null);
var fn_name = cljs.core.nth.call(null,vec__36520,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__36520,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__36520,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__36520,(4),null);
var arity = cljs.core.nth.call(null,vec__36520,(5),null);
...
var o__35547__auto__ = f;
return (o__35547__auto__["getBasis"]).call(o__35547__auto__);
});
/**
...
}catch (e36524){var _e__35554__auto__ = e36524;
...
var G__36525 = (obj[cljs.core.first.call(null,path)]);
var G__36526 = cljs.core.rest.call(null,path);
obj = G__36525;
path = G__36526;
continue;
} else {
...
return (function (accum,p__36527){
var vec__36528 = p__36527;
var bit = cljs.core.nth.call(null,vec__36528,(0),null);
var protocol = cljs.core.nth.call(null,vec__36528,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__36531){
var vec__36532 = p__36531;
var ns = cljs.core.nth.call(null,vec__36532,(0),null);
var name = cljs.core.nth.call(null,vec__36532,(1),null);
var selector = cljs.core.nth.call(null,vec__36532,(2),null);
...
return (function (p__36536){
var vec__36537 = p__36536;
var munged_name = cljs.core.nth.call(null,vec__36537,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__36537,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__36537,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__36535_SHARP_){
return (obj[cljs.core.first.call(null,p1__36535_SHARP_)]);
});})(name,sorted_matches,vec__36537,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1561299748510
