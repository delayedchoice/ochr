...
var file = cljs.core.get.call(null,map__42626__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__42626__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__42626__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e42625){var _e = e42625;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5733__auto___42628 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5733__auto___42628)){
var seen_errors_42629 = temp__5733__auto___42628;
if(cljs.core.truth_(seen_errors_42629.has(self))){
} else {
seen_errors_42629.add(self);

var temp__5735__auto___42630 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5735__auto___42630)){
var sense_42631 = temp__5735__auto___42630;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_42631)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1561299756887
