...
if((c === "\n")){
var G__37376 = escape_QMARK_;
var G__37377 = rewrite_clj.parser.string.flush_into.call(null,lines,buf);
escape_QMARK_ = G__37376;
lines = G__37377;
continue;
} else {
buf.append(c);

var G__37378 = (((!(escape_QMARK_))) && ((c === "\\")));
var G__37379 = lines;
escape_QMARK_ = G__37378;
lines = G__37379;
continue;
...
//# sourceMappingURL=string.js.map?rel=1561299749863
