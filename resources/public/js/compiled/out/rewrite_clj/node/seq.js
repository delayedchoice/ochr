...
rewrite_clj.node.seq.SeqNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4387__auto__,k37182,else__4388__auto__){
var self__ = this;
var this__4387__auto____$1 = this;
var G__37186 = k37182;
var G__37186__$1 = (((G__37186 instanceof cljs.core.Keyword))?G__37186.fqn:null);
switch (G__37186__$1) {
case "tag":
return self__.tag;
...
break;
default:
return cljs.core.get.call(null,self__.__extmap,k37182,else__4388__auto__);
...
return (function (ret__4407__auto__,p__37187){
var vec__37188 = p__37187;
var k__4408__auto__ = cljs.core.nth.call(null,vec__37188,(0),null);
var v__4409__auto__ = cljs.core.nth.call(null,vec__37188,(1),null);
...
rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__37181){
var self__ = this;
var G__37181__$1 = this;
return (new cljs.core.RecordIter((0),G__37181__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tag","tag",-1290361223),new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator.call(null,self__.__extmap):cljs.core.nil_iter.call(null))));
});
...
rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this37183,other37184){
var self__ = this;
var this37183__$1 = this;
return (((!((other37184 == null)))) && ((this37183__$1.constructor === other37184.constructor)) && (cljs.core._EQ_.call(null,this37183__$1.tag,other37184.tag)) && (cljs.core._EQ_.call(null,this37183__$1.wrap_fn,other37184.wrap_fn)) && (cljs.core._EQ_.call(null,this37183__$1.wrap_length,other37184.wrap_length)) && (cljs.core._EQ_.call(null,this37183__$1.seq_fn,other37184.seq_fn)) && (cljs.core._EQ_.call(null,this37183__$1.children,other37184.children)) && (cljs.core._EQ_.call(null,this37183__$1.__extmap,other37184.__extmap)));
});
...
rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4392__auto__,k__4393__auto__,G__37181){
var self__ = this;
var this__4392__auto____$1 = this;
var pred__37191 = cljs.core.keyword_identical_QMARK_;
var expr__37192 = k__4393__auto__;
if(cljs.core.truth_(pred__37191.call(null,new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__37192))){
return (new rewrite_clj.node.seq.SeqNode(G__37181,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__37191.call(null,new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),expr__37192))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,G__37181,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__37191.call(null,new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),expr__37192))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,G__37181,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__37191.call(null,new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),expr__37192))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,G__37181,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__37191.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__37192))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,G__37181,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__4393__auto__,G__37181),null));
}
}
}
}
...
rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4384__auto__,G__37181){
var self__ = this;
var this__4384__auto____$1 = this;
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,G__37181,self__.__extmap,self__.__hash));
});
 ...
 */
rewrite_clj.node.seq.map__GT_SeqNode = (function rewrite_clj$node$seq$map__GT_SeqNode(G__37185){
var extmap__4424__auto__ = (function (){var G__37194 = cljs.core.dissoc.call(null,G__37185,new cljs.core.Keyword(null,"tag","tag",-1290361223),new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),new cljs.core.Keyword(null,"children","children",-940561982));
if(cljs.core.record_QMARK_.call(null,G__37185)){
return cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,G__37194);
} else {
return G__37194;
}
})();
return (new rewrite_clj.node.seq.SeqNode(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(G__37185),new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130).cljs$core$IFn$_invoke$arity$1(G__37185),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519).cljs$core$IFn$_invoke$arity$1(G__37185),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231).cljs$core$IFn$_invoke$arity$1(G__37185),new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__37185),null,cljs.core.not_empty.call(null,extmap__4424__auto__),null));
});
...
return rewrite_clj.node.seq.__GT_SeqNode.call(null,new cljs.core.Keyword(null,"list","list",765357683),rewrite_clj.node.seq.wrap_list,(2),(function (p1__37196_SHARP_){
return cljs.core.apply.call(null,cljs.core.list,p1__37196_SHARP_);
}),children);
});
/**
...
return rewrite_clj.node.seq.__GT_SeqNode.call(null,new cljs.core.Keyword(null,"map","map",1371690461),rewrite_clj.node.seq.wrap_map,(2),(function (p1__37197_SHARP_){
return cljs.core.apply.call(null,cljs.core.hash_map,p1__37197_SHARP_);
}),children);
});

//# sourceMappingURL=seq.js.map?rel=1561299749453
